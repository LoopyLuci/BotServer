 ...
 * out of sync. GitHub self-update lives in the separate, pairing-
 * independent AppUpdateViewModel (see ui/update/) — SettingsScreen uses
 * both view models side by side rather than this one absorbing update
 * logic that PairingScreen needs too, pre-pairing. */
@HiltViewModel
